...
export const SignInPanel = ({ setShowSignUp }: SignInPanelProps) => {
  ...
  return (
    <Stack spacing={4} w={'full'} maxW={'md'} className='slide-in-right'>
      ...
      <Stack
        ...
        align={'center'}
      >
        <Link onClick={() => setShowSignUp(true)} color={'blue.500'}>Register with email</Link>
      </Stack>
    </Stack>
  )
}
